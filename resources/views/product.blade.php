...
<div><br><br></div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="p-4">
                        <div class="mb-3">
                            ...
                            <span style="background-color: #fd9d3e; color:white"  class="badge badge mr-1">{{is_null($product->category_id)?'Uncategorized':$product->category->name}}</span>
                        ...
                        <form class="d-flex justify-content-left" action="{{route('product.add')}}" method="get">
                            ...
                            <button style="background-color: #fd9d3e; color:white" class="btn btn-md my-0 ml-2 p" type="submit">Add to cart
                ...
                <div class="col-12 col-lg-12">
                    <div class="nav-wrapper">
                        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                            <li  class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active"  style="background-color: #fd9d3e; color:white" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true">Description</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0" style="background-color: #fd9d3e; color:white" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">Reviews({{count($reviews)}})</a>
                            </li>
                        </ul>
                    </div>
                                                    ...
                                                    @if (Auth::user())
                                                        <form id="review-form" action="{{route('product.add-review')}}" method="post">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span style="background-color: #fd9d3e; color:white" class="live-rating badge badge-primary"></span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <button style="background-color: #fd9d3e; color:white" class="btn btn-md my-0 ml-2 p" type="submit">Add review
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
		...
		<div class="container">
			...
			<div class="customer-inner">
				<div class="headding-part pb-50 text-center">
					...
					<h2 class="headding-title text-uppercase font-weight-bold">You might like</h2>
				</div>
				<div class="row">
    ...
    {{-- <section class="special-menu ptb pt-10">
