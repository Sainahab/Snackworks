        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="page-title">
                    <h1 class="page-headding">Payment</h1>
                    
                     <p style="color: #ffffff; " class="lead">Please proceed with the payment methods</p>
        ...
        <div class="col-12 col-lg-12 text-center">
            <div class="nav-wrapper">
                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0 active" style="background-color: #fd9d3e; color:white" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true">Cash on delivery</a>
                    </li>
                    {{-- <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                            <form action="{{route('checkout.cod')}}" method="post">
                                ...
                                <button type="submit" style="background-color: #fd9d3e; color:white" class="btn btn-lg ">Proceed</button>
                            </form>
                        </div>
