			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12">
					<div class="page-title">
						<h1  class="page-headding">Edit address</h1>
						<p style="color:white" class="lead">Edit your address here</p>
					</div>
				</div>
			</div>
		</div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card border-light">
                <div style="color:#fd9d3e;" class="card-header">Edit address</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('profile.billing')}}" method="post">
                      @csrf
                      <h6 style="color:#fd9d3e;" class="heading-small text mb-4">Shipping information</h6>
                      <div class="pl-lg-4">
                        <div class="row">
                          <div class="col-lg-6">
                        ...
                        {{-- <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="input-phone">Shipping phone</label>
                              <input type="text" name="billing_phone" class="form-control" value="{{$billing_phone}}">
                            </div>
                          </div>
                        </div> --}}
                        {{-- <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              <button type="submit" style="background-color:#fd9d3e; color:white" class="btn">Save</button>
                            </div>
                          </div>
                        </div>
                      </div>
